...
public class DomainDocumenter : IDomainDocumenter {
	...
	public DomainDocumenter(IAuthorizationRoleRegistry roleRegistry, IServiceProvider services) {
	...
	public string GenerateMarkdown() {
		...
		var combinedInfo = DomainModel.Instance.GetAllRules();
	...
	public string GenerateCsv() {
		...
		var rules = DomainModel.Instance.GetAuthorizationRules();
	...
	private AnalysisReport GetAnalysisReport() {
		var analyzer = DomainAnalyzerProvider.CreateAnalyzer(this._roleRegistry, this._services);
